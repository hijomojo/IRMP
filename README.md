...
| `IR_OUTPUT_IS_ACTIVE_HIGH` | disabled | Output HIGH for active IR signal. Use it with IRSND_GENERATE_NO_SEND_RF to force active high without the carrier frequency. |
